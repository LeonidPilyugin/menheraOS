...
For a start, download the latest MenheraOS ISO from [DropBox](https://www.dropbox.com/scl/fi/xs91p9vcbwz6z4dxnhlsg/menheraos-04_02_2024-x86_64.iso?rlkey=97o2tam6lwspz8wo1nib0rqxf&dl=0) or releases. Also you can build it yourself but we don't recommend it because there may be problems between installer and new packages.
