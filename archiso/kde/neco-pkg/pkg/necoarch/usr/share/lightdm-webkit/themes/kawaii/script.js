...
function show_prompt(text) {
  ...
  if (!isVisible(password_container)) {
    ...
    password_entry.placeholder= "Onii-chan, passwold please \=>_\<="
  }
...
function update_time() {
  ...
  time.innerHTML= "Onii-chan, cuwent time is " + hh+":"+mm +":" + ss;
}
...
function initialize_actions() {
  ...
  if (lightdm.can_restart) {
    add_action("restart", "Restawt", "img/restart.svg", function(e) {lightdm.restart(); e.stopPropagation();}, template, parent);
  }
