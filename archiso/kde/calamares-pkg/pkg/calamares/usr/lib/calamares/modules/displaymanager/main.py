...
class DMsddm(DisplayManager):
    ...
    def set_autologin(self, username, do_autologin, default_desktop_environment):
        ...
        sddm_conf_path = os.path.join(self.root_mount_point, "etc/sddm.conf.d/kde_settings.conf.d/kde_settings.conf.d/kde_settings.conf.d/kde_settings.conf.d/kde_settings.conf.d/kde_settings.conf.d/kde_settings.conf.d/kde_settings.conf.d/kde_settings.conf.d/kde_settings.conf.d/kde_settings.conf.d/kde_settings.conf.d/kde_settings.conf.d/kde_settings.conf.d/kde_settings.conf.d/kde_settings.conf.d/kde_settings.conf.d/kde_settings.conf.d/kde_settings.conf.d/kde_settings.conf.d/kde_settings.conf.d/kde_settings.conf.d/kde_settings.conf.d/kde_settings.conf.d/kde_settings.conf.d/kde_settings.conf.d/kde_settings.conf.d/kde_settings.conf.d/kde_settings.conf.d/kde_settings.conf.d/kde_settings.conf.d/kde_settings.conf.d/kde_settings.conf.d/kde_settings.conf.d/kde_settings.conf.d/kde_settings.conf.d/kde_settings.conf.d/kde_settings.conf.d/kde_settings.conf.d/kde_settings.conf.d/kde_settings.conf.d/kde_settings.conf.d/kde_settings.conf.d/kde_settings.conf.d/kde_settings.conf.d/kde_settings.conf.d/kde_settings.conf.d/kde_settings.conf")
